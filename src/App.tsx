...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-[#FDFBF7] text-stone-800 selection:bg-primary/20 selection:text-primary overflow-x-hidden pb-0">
      ...
      <Navbar
        logoText={lang === "bn" ? memoryData.coupleNameBn : memoryData.coupleNameEn}
        lang={lang}
        setLang={setLang}
      ...
      <Hero
        heading={lang === "bn" ? memoryData.heroHeadingBn : memoryData.heroHeadingEn}
        buttonText={lang === "bn" ? "আমাদের গল্প দেখো" : "EXPLORE OUR STORY"}
        subtitle={lang === "bn" ? "একটি জায়গা, একটি মুহূর্ত" : "A PLACE, A MOMENT"}
      ...
      <StorySection
        id="first-meeting"
        header={lang === "bn" ? memoryData.reunionHeaderBn : memoryData.reunionHeaderEn}
        locationText={lang === "bn" ? memoryData.reunionLocationBn : memoryData.reunionLocationEn}
        imageUrl={memoryData.reunionImage}
        storyText={lang === "bn" ? memoryData.reunionTextBn : memoryData.reunionTextEn}
        lang={lang}
      />
      ...
      <div id="photos-gallery">
        <GallerySection
          title={lang === "bn" ? memoryData.galleryTitleBn : memoryData.galleryTitleEn}
      ...
      <div id="cinemagraph-videos">
        <VideoSection
          cinemagraphs={memoryData.cinemagraphs}
          lang={lang}
        />
      </div>
      ...
      <div id="timeline-milestones">
        <TimelineSection
          title={lang === "bn" ? memoryData.timelineTitleBn : memoryData.timelineTitleEn}
      ...
      <SecretSection
        title={lang === "bn" ? memoryData.secretBoxTitleBn : memoryData.secretBoxTitleEn}
        message={lang === "bn" ? memoryData.secretMessageBn : memoryData.secretMessageEn}
        quizQuestion={lang === "bn" ? memoryData.secretQuizQuestionBn : memoryData.secretQuizQuestionEn}
      ...
      <MapSection
        ...
        locationStr={lang === "bn" ? memoryData.mapLocationStrBn : memoryData.mapLocationStrEn}
        ...
        <div className="max-w-3xl text-center space-y-6">
          ...
          <div className="pt-6 border-t border-[#6c5842]/10 flex flex-col items-center">
            <p className="text-stone-400 text-xs tracking-wider">
              {lang === "bn"
                ? "© ২০২৪ আমাদের গল্প। শাহ আমানত বিমানবন্দর, চট্টগ্রাম।"
                : "© 2024 Our Memory Space. Shah Amanat Airport, Chattogram."}
            </p>
          </div>
        </div>
      </footer>
