      ...
      <div className='max-w-6xl mx-auto'>
        <div className='text-center mb-16 flex flex-col items-center'>
          ...
          <p className='text-xs text-on-surface-variant/60 font-mono mt-3 uppercase tracking-widest'>
            {lang === 'bn'
              ? '(ছবিতে ক্লিক করে পেছনে লেখা অনুভূতি দেখুন!)'
              : '(Click on a card to flip and view the handwritten note!)'}
          </p>
        </div>
            ...
            return (
              <motion.div
                ...
                className={`perspective-1000 cursor-pointer h-[380px] w-full ${
                  photos.length % 4 === 2 && index === photos.length - 2
                    ? 'lg:col-start-2'
                    : ''
                }`}
                ...
                >
                  <div className='absolute inset-0 w-full h-full backface-hidden bg-white p-4 shadow-md border border-neutral-200/50 flex flex-col justify-between rounded-sm'>
                    <div className='relative w-full h-[260px] bg-neutral-100 overflow-hidden group'>
                      <img
                        src={photo.image}
                        alt={lang === 'bn' ? photo.captionBn : photo.captionEn}
                  ...
                  <div className='absolute inset-0 w-full h-full backface-hidden rotate-y-180 bg-stone-50 p-6 shadow-md border-2 border-stone-200/80 flex flex-col justify-between rounded-sm overflow-hidden'>
                    ...
                    <div className='relative z-10 pl-4'>
                      ...
                      <p
                        style={{ fontFamily: '"EB Garamond", serif' }}
                        className='text-base text-primary-container leading-relaxed italic text-justify pt-1 font-light max-h-[260px] overflow-y-auto pr-2'
                      >
