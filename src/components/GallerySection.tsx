  ...
  return (
    <section className='py-24 bg-surface-container-low px-6'>
      <div className='max-w-6xl mx-auto'>
        ...
        {/* Polaroid grid */}
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 place-items-cente'>
                ...
                >
                  ...
                  <div className='absolute inset-0 w-full h-full backface-hidden rotate-y-180 bg-stone-50 p-6 shadow-md border-2 border-stone-200/80 flex flex-col justify-between rounded-sm relative overflow-hidden'>
                    ...
                    <div className='relative z-10 pl-4'>
                      ...
                      <p
                        style={{ fontFamily: '"EB Garamond", serif' }}
                        className='text-base text-primary-container leading-relaxed italic text-justify pt-1 pr-1 font-light max-h-[260px] overflow-y-auto pr-2'
                      >
